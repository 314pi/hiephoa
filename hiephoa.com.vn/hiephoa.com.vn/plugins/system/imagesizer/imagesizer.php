...
#		JHtml::_('script','plugins/system/imagesizer/js/popup-imagemanager.js', true, true);
	...
	private function redim_support(){
		...
		$c="\n".base64_decode('PG5vc2NyaXB0PjwhLS0gcmVEaW0gLSBJbWFnZVNpemVyIGZvciBKb29tbGEgLS0+PGEgdGl0bGU9Ikpvb21sYSAtIFBsdWdpbnMiIGhyZWY9Imh0dHA6Ly93d3cucmVkaW0uZGUvIj5JbWFnZVNpemVyIGZvciBKb29tbGEhIENvcHlyaWdodCAoYykyMDEyIHJlRGltPC9hPjwvbm9zY3JpcHQ+')."\n";
