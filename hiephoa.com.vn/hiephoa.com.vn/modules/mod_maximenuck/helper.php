...
class modMaximenuckHelper
{
	...
	static function getItems(&$params)
	{
		...
		if (!($items = $cache->get($key)))
		{
			...
			{
				// TODO ajouter classes first et last, attention aussi pour chaque colonne
				...
				$item->createnewrow = $item->params->get('maximenu_createnewrow', 0);
				$item->submenucontainerwidth = $item->params->get('maximenu_submenucontainerwidth', '');
				...
				if (isset($parentItem->submenucontainerwidth) AND $parentItem->submenucontainerwidth) $parentItem->submenuswidth = $parentItem->submenucontainerwidth; // TODO : vérifier comportement si OK
