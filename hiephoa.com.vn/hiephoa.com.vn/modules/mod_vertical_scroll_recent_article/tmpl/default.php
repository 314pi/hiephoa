...
if ( ! empty($items) ) 
{
	...
	foreach ( $items as $item ) 
	{
		...
		@$vspost_html = @$vspost_html . "<div class='crs_div' style='height:$dis_height;padding:2px 0px 2px 20px;'>"; 
		@$vspost_html = @$vspost_html . "<a href='$vspost_link'>$vspost_title</a>";
		@$vspost_html = @$vspost_html . "</div>";
		
		@$vspost_x = @$vspost_x . "crs_array[$vspost_count] = '<div class=\'crs_div\' style=\'height:$dis_height;padding:2px 0px 2px 10px;\'><a href=\'$vspost_link\'>$vspost_title</a></div>'; ";	
		@$vspost_count++;
	}
}
