  ...
  setTimeout('document.adminForm.task.value="manualsave"',300);
	...
	<table  cellpadding="4" cellspacing="4" border="0" width="750">
      <tr>
        ...
        <td valign="top"><ul><li><a href="index.php?option=com_swmenufree&amp;task=editDhtmlMenu" ><?php echo _SW_MANAGER_LINK; ?></a></li></ul></td>
     </tr>
    </table>
...
<table  cellpadding="4" cellspacing="4" border="0" width="750">
  <tr>
     ...
     <td valign="top" ><ul><li><a href="index.php?option=com_swmenufree&task=showmodules" ><?php echo _SW_MANAGER_LINK; ?></a></li></ul></td>
   </tr>
</table>
...
<table  cellpadding="4" cellspacing="0" border="0" width="750">
  <tr>
     ...
     <td valign="top" >
      ...
      <li><a href="index.php?option=com_swmenufree&amp;task=editCSS&amp;id=<?php echo $row2->id; ?>" ><?php echo _SW_CSS_LINK; ?></a></li>
       <?php } else{ ?>
      <li><a href="javascript:void(0);" onClick="doExport();" ><?php echo _SW_EXPORT_LINK; ?></a></li>
       <?php } ?>
      <li><a href="index.php?option=com_swmenufree&amp;task=upgrade"  ><?php echo _SW_UPGRADE_LINK; ?></a></li>
       </ul>
    </td>
  </tr>
</table>
