...
$registry = new JRegistry();
	...
	$parent_id=JRequest::getVar( 'parentid', 1 );
...
echo "</head><body>";
echo GosuMenu($ordered, $swmenufree, $active_menu,$selectbox_hack,$overlay_hack=0);
echo changeBgColor();
echo "</body></html>";
}
...
echo SuperfishMenu($ordered, $swmenufree, $active_menu,$selectbox_hack,$sub_active,$show_shadow, $sub_indicator,$overlay_hack=0);
echo "</div>";
echo changeBgColor();
echo "</body></html>";
}
